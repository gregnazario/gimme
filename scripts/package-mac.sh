...
#   GimmeUI-<version>-arm64.dmg signed + notarized drag-to-Applications DMG
#
# Environment:
...
DMG="$DIST/GimmeUI-$VERSION-arm64.dmg"
# Same recipe as the CI release (scripts/make-dmg.sh): background graphic
...
sh scripts/make-dmg.sh "$DMG" "gimme $VERSION"
